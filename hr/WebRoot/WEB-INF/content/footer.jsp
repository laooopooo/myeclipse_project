...
<table width="780" border="0" cellspacing="0" align="center">
	<tr>
		<td background="${pageContext.request.contextPath}/images/bodybg.jpg">
			...
			<table width="90%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="283"><img
						src="${pageContext.request.contextPath}/images/struts2.png"
						width="188" height="66"></td>
					<td width="246"><img
						src="${pageContext.request.contextPath}/images/spring.gif"
						width="152" height="66"></td>
					<td width="243"><img
						src="${pageContext.request.contextPath}/images/hibernate.png"
						width="203" height="56"></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td height="68"
			background="${pageContext.request.contextPath}/images/bodybg.jpg"><p
				align="center" class="pt9">
				All Rights Reserved.&copy; <a href="http://www.crazyit.org">http://www.crazyit.org</a><br />
				版权所有 Copyright&copy;2008 Yeeku.H.Lee <br /> 如有任何问题和建议，请登录<a
					href="http://www.crazyit.org">http://www.crazyit.org</a><br />
				建议您使用1024*768分辨率，IE5.0以上版本使用本系统!
			</p></td>
	</tr>
	<tr height="5">
